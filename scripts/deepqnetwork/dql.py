...
# -*- coding: utf-8 -*-
"""
Created on Fri Jan 22 15:50:12 2021
...
# initalize a replay memory D to capacity N
...
class ReplayBuffer():
    ...
    def store_transition (self, state, action, reward, state_ , done):
        ...
        self.new_state_memory = state_
        self.action_memory = action
        self.terminal_memory = 1 - int (done) #want to multiply the reward by 0 (can also do it in learn function)
